...
import { FaFileDownload, FaFilter, FaUsers } from "react-icons/fa";
import { employeeReports, departments } from "../../../data/reports";
import type { ReportDepartment } from "../../../types/reports";
import { Link } from "react-router-dom";

export default function EmployeeReports() {
  const [selectedDepartment, setSelectedDepartment] =
    useState<ReportDepartment>("all");

  return (
    <div className="space-y-6">
      <div className="flex justify-end">
        <Link
          to="/pms/reports/employee/generate"
      ...
      <div className="bg-white p-4 rounded-lg shadow flex flex-wrap gap-4 items-center">
        <div className="flex items-center">
          ...
          <select
            ...
            onChange={(e) =>
              setSelectedDepartment(e.target.value as ReportDepartment)
            }
          >
              ...
              {employeeReports.map((report) => (
                ...
                >
                  <td className="px-3 md:px-6 py-4">
                    <div className="flex items-center">
                      <FaUsers className="h-5 w-5 text-green-600 mr-2 hidden sm:block flex-shrink-0" />
