...
import { FaFileDownload, FaFilter, FaCalculator } from "react-icons/fa";
import { taxReports, formatCurrency } from "../../../data/reports";
              ...
              {taxReports.map((report) => (
                ...
                >
                  <td className="px-3 md:px-6 py-4">
                    <div className="flex items-center">
                      <FaCalculator className="h-5 w-5 text-green-600 mr-2 hidden sm:block flex-shrink-0" />
                  ...
                  <td className="px-3 md:px-6 py-4 whitespace-nowrap">
                    <span
                      className={`px-2 inline-flex text-xs md:text-sm leading-5 font-semibold rounded-full
                               ${complianceColors[report.compliance]}`}
                    >
                      {report.compliance}
                    </span>
                  </td>
