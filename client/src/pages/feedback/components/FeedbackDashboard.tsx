...
const FeedbackDashboard = ({ analytics }: FeedbackDashboardProps) => {
  ...
  const [selectedItem, setSelectedItem] = useState<Feedback | Incident | null>(
    null
  );
  ...
  const [filter, setFilter] = useState({
    ...
    endDate: new Date(Date.now() + 1 * 24 * 60 * 60 * 1000)
      .toISOString()
      .split("T")[0], // Tomorrow (to include today)
    departmentId: "",
    searchTerm: "",
  });
        ...
        setIncidents([
          {
            ...
            category: "Safety",
            description:
              "Broken glass near the loading dock that presents a safety hazard for workers in the area. This requires immediate attention to prevent potential injuries.",
          ...
          },
          {
            ...
            category: "Security",
            description:
              "Multiple unauthorized login attempts detected on the customer database between 2am-4am. IP addresses have been logged and preliminary investigation suggests external origin.",
                  ...
                  <div key={category.name}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (category.count / analytics.totalFeedback) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
                  ...
                  <div key={dept.name || "unknown"}>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div
                        ...
                        style={{
                          width: `${
                            (dept.count / analytics.totalFeedback) * 100
                          }%`,
                        }}
                      ></div>
                    </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-8 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-500 mb-4">
                There's no feedback matching your current filters
              </p>
            </div>
          ) : (
                      ...
                      <td className="px-4 py-4">
                        <div className="flex space-x-2">
                          <button
                            onClick={() =>
                              item._id &&
                              updateFeedbackStatus(item._id, "Approved")
                            }
                          ...
                          <button
                            onClick={() =>
                              item._id &&
                              updateFeedbackStatus(item._id, "Rejected")
                            }
                          ...
                          <button
                            onClick={() =>
                              item._id &&
                              updateFeedbackStatus(item._id, "Resolved")
                            }
                      ...
                      <td className="px-4 py-4">
                        <div className="flex space-x-2">
                          <button
                            onClick={() =>
                              incident._id &&
                              updateIncidentStatus(incident._id, "Approved")
                            }
                            disabled={
                          ...
                          <button
                            onClick={() =>
                              incident._id &&
                              updateIncidentStatus(incident._id, "Rejected")
                            }
                            disabled={
                          ...
                          <button
                            onClick={() =>
                              incident._id &&
                              updateIncidentStatus(incident._id, "Resolved")
                            }
                            disabled={
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="font-medium">
                      {"isAnonymous" in selectedItem && selectedItem.isAnonymous
                        ...
                        ? `${selectedItem.submittedBy.firstName || ""} ${
                            selectedItem.submittedBy.lastName || ""
                          }`
                        : "Unknown"}
                    </p>
                  </div>
                  ...
                  {"recipientDepartment" in selectedItem &&
